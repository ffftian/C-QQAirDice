	...
	std::string FormStringSeparate() const
	{
		...
		for (auto i = vvintRes.begin(); i != vvintRes.end(); ++i)
		{
			...
			else
			{
				...
				strReturnString.append(vBnP[distance(vvintRes.begin(), i)] == B_Dice ? "[奖励骰:" : "[惩罚骰:");
...
/*
extern "C"  _declspec(dllexport) void COC7(std::string&, int);
inline void DND(std::string&, int);
...
extern "C"  _declspec(dllexport)  inline void init2(std::string&);
extern "C"  _declspec(dllexport)  inline void COC6D(std::string&);
extern "C"  _declspec(dllexport)  inline void COC6(std::string&, int);
extern "C"  _declspec(dllexport)  inline void COC7(std::string&, int);
extern "C"  _declspec(dllexport)  inline void DND(std::string&, int);
extern "C"  _declspec(dllexport)  inline void LongInsane(std::string&);
extern "C"  _declspec(dllexport)  inline void TempInsane(std::string&);

extern "C"  _declspec(dllexport)  inline std::string Tempaa(std::string& a);
extern "C"  _declspec(dllexport)  inline void Tempaa2(std::string& a);
*/
//extern "C"  _declspec(dllexport)   Char* Temp3(Char* a);
