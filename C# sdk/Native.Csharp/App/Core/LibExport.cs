...
namespace Native.Csharp.App.Core
{
    public class LibExport
    {
		...
		private static string AppInfo ()
		{
			// 请勿随意修改
			// 
			Common.AppName = "xianbei";
			Common.AppVersion = Version.Parse ("1.0.0");		

			//
			// 当前项目名称: top.tian.xianbei
			// Api版本: 9

			return string.Format ("{0},{1}", 9, "top.tian.xianbei");
		}
		...
		private static void ResolveAppbackcall ()
		{
            ...
            if (Common.UnityContainer.IsRegistered<IReceiveALLPrivateMessage>("私聊消息处理") == true)
            {
                ReceiveALLPrivateMessage_1 = Common.UnityContainer.Resolve<IReceiveALLPrivateMessage>("私聊消息处理").ReceiveALLPrivateMessage;
            }
            //ReceiveALLPrivateMessage_1
            /*
			 * Id: 2
			 * Name: 群消息处理
			 */
        ...
        public static event EventHandler<CqPrivateMessageEventArgs> ReceiveALLPrivateMessage_1;
		...
		{
            if (ReceiveFriendMessage_1 != null || ReceiveGroupPrivateMessage_1 != null || ReceiveOnlineStatusMessage_1 != null
